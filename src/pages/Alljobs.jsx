  ...
  return (
    <div className=" bg-gradient-to-b from-gray-50 to-white dark:from-gray-900 dark:to-gray-800">
      <div className="w-11/12 mx-auto mb-25 ">
        <div className="pt-5">
          <div className="bg-gray-100 dark:bg-gray-900 md:p-5 py-7 rounded-lg">
            <h3 className="text-xl md:pl-0 pl-2 font-semibold">
                ...
                <div className="md:pl-0 pl-2">
                  <div onClick={haldelSort}>
                    <select
                      ...
                      className="dark:bg-white select mt-2  w-[180px] focus:outline-none rounded-xl backdrop-blur shadow-lg border border-gray-200 
